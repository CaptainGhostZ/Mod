...
;New section for royal and lab status
	Local $x = 202, $y = $y_bottom + 5
		...
		$g_hlblKing = GUICtrlCreateLabel("King", $x, $y, 50, 16, $SS_LEFT)
			...
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicKingGray = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnGrayShield, $x + 53, $y, 16, 16)
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicKingBlue = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnBlueShield, $x + 53, $y, 16, 16)
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicKingGreen = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnGreenShield, $x + 53, $y, 16, 16)
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicKingRed = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnRedShield, $x + 53, $y, 16, 16)
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
	...
	$y += 25
		$g_hlblQueen = GUICtrlCreateLabel("Queen", $x, $y, 50, 16, $SS_LEFT)
	  		_GUICtrlSetTip(-1, $sTxtTip)
			;GUICtrlSetBkColor(-1, 0xE1E1E1)
		$g_hPicQueenGray = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnGrayShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicQueenBlue = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnBlueShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicQueenGreen = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnGreenShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicQueenRed = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnRedShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
	...
	$y += 25
		$g_hlblWarden = GUICtrlCreateLabel("Warden", $x, $y, 50, 16, $SS_LEFT)
	  		_GUICtrlSetTip(-1, $sTxtTip)
			;GUICtrlSetBkColor(-1, 0xE1E1E1)
		$g_hPicWardenGray = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnGrayShield, $x + 53 , $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicWardenBlue = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnBlueShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicWardenGreen = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnGreenShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicWardenRed = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnRedShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
	...
	$y += 25
		...
		$g_hlblLab = GUICtrlCreateLabel("Lab", $x, $y, 50, 16, $SS_LEFT)
	  		_GUICtrlSetTip(-1, $sTxtTip)
			;GUICtrlSetBkColor(-1, 0xE1E1E1)
		$g_hPicLabGray = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnGrayShield, $x + 53 , $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicLabGreen = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnGreenShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicLabRed = _GUICtrlCreateIcon ($g_sLibIconPathMOD, $eIcnRedShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE) 
