...
;New section for royal and lab status
	Local $x = 202, $y = $y_bottom + 5
		...
		$g_hlblKing = GUICtrlCreateLabel("King", $x, $y, 50, 16, $SS_LEFT)
			...
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicKingGray = _GUICtrlCreatePic($g_sIcnGrayShield, $x + 53, $y, 16, 16)
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicKingBlue = _GUICtrlCreatePic($g_sIcnBlueShield, $x + 53, $y, 16, 16)
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicKingGreen = _GUICtrlCreatePic($g_sIcnGreenShield, $x + 53, $y, 16, 16)
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicKingRed = _GUICtrlCreatePic($g_sIcnRedShield, $x + 53, $y, 16, 16)
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
	...
	$y += 25
		$g_hlblQueen = GUICtrlCreateLabel("Queen", $x, $y, 50, 16, $SS_LEFT)
	  		_GUICtrlSetTip(-1, $sTxtTip)
			;GUICtrlSetBkColor(-1, 0xE1E1E1)
		$g_hPicQueenGray = _GUICtrlCreatePic($g_sIcnGrayShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicQueenBlue = _GUICtrlCreatePic($g_sIcnBlueShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicQueenGreen = _GUICtrlCreatePic($g_sIcnGreenShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicQueenRed = _GUICtrlCreatePic($g_sIcnRedShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
	...
	$y += 25
		$g_hlblWarden = GUICtrlCreateLabel("Warden", $x, $y, 50, 16, $SS_LEFT)
	  		_GUICtrlSetTip(-1, $sTxtTip)
			;GUICtrlSetBkColor(-1, 0xE1E1E1)
		$g_hPicWardenGray = _GUICtrlCreatePic($g_sIcnGrayShield, $x + 53 , $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicWardenBlue = _GUICtrlCreatePic($g_sIcnBlueShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicWardenGreen = _GUICtrlCreatePic($g_sIcnGreenShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicWardenRed = _GUICtrlCreatePic($g_sIcnRedShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
	...
	$y += 25
		...
		$g_hlblLab = GUICtrlCreateLabel("Lab", $x, $y, 50, 16, $SS_LEFT)
	  		_GUICtrlSetTip(-1, $sTxtTip)
			;GUICtrlSetBkColor(-1, 0xE1E1E1)
		$g_hPicLabGray = _GUICtrlCreatePic($g_sIcnGrayShield, $x + 53 , $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
		$g_hPicLabGreen = _GUICtrlCreatePic($g_sIcnGreenShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE)
		$g_hPicLabRed = _GUICtrlCreatePic($g_sIcnRedShield, $x + 53, $y, 16, 16 )
	  		_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_HIDE) 
